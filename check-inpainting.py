...
COORDS_FILENAME = "coords-snr-fake-10259.txt"
# ALM_FILENAME = "websky/lensed_alm.fits"
INP_FILENAME = "inpainted_fake_map_zeros_6000.fits"
INP2_FILENAME = "uninpainted_fake_map_zeros_6000.fits"
...
josh_wlrecon.lensed_vs_inpaint_map(inpainted_map, uninpainted_map,
                                   sampled, title="websky-null-inpaint-vs-noninpaint",
