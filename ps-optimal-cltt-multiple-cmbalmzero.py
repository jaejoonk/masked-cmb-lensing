...
PATH_TO_SCRATCH = "/home3/jaejoonk/data/dr7/"
...
FILTERED_MAP_ZERO_FILENAME = PATH_TO_SCRATCH + "optimal_filtered_6000_cmbalmzero.fits"
FILTERED_MAP_NO_ZERO_FILENAME = PATH_TO_SCRATCH + "optimal_filtered_6000_nocmbalmzero.fits"
FILTERED_MAP_AP_FILENAME = PATH_TO_SCRATCH + "optimal_filter_1.0_6000_cmbalmzero_ap.fits"
#INPAINTED_MAP_FILENAME = PATH_TO_SCRATCH + "inpainted_map_websky_random_fake_6000.fits"
SNR_COORDS_FILENAME = "coords-snr-5-fake-10259.txt"

CLTT_OUTPUT_NAME = f"ps_cltt_optimal_comparison_1.0_6000_comparison_{ESTS[0]}.png"
CLTT_RAW_OUTPUT_NAME = f"ps_raw_cltt_optimal_comparison_1.0_6000_comparison_{ESTS[0]}.png"
...
filtered_zero_ap_map = enmap.read_map(FILTERED_MAP_ZERO_AP_FILENAME)
optimal_zero_ap_alm = cs.map2alm(filtered_zero_ap_map, lmax=LMAX)
# convolve beam for optimal filtering
optimal_zero_ap_alm = cs.almxfl(optimal_zero_ap_alm, BEAM_FN)
###############################
...
optimal_zero_cls = hp.alm2cl(optimal_zero_alm.astype(np.cdouble),
                             ...
                             lmax=LMAX)
optimal_ap_cls = hp.alm2cl(optimal_zero_ap_alm.astype(np.cdouble),
                           optimal_zero_ap_alm.astype(np.cdouble),
                           lmax=LMAX)
...
pl_tt.add(*bin((optimal_ap_cls - empty_cls) / empty_cls), marker='o', label="optimal filtering (apodized CMB) vs no masking")
